...
def go_dependencies():
    ...
    go_repository(
        ...
        sum = "h1:XBI8oqrsxn6iZsOifgEzopSjN4ut0IAbFdYPlRbnCmk=",
        version = "v2.4.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:Hsx+baY8/zU2WtPLQyZi8WbecgcsWEeyoK1jvg/WgIo=",
        version = "v4.17.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:jjMGfJk1DXVpC+mCAz7ZRvMruaujSIx8ZygHyaDsHLU=",
        version = "v0.0.0-20220911232807-b8f8258b5686",
    )
    go_repository(
        name = "com_github_melon_network_inc_common",
        importpath = "github.com/Melon-Network-Inc/common",
        sum = "h1:4DZ3MqLb3u8TAQGAJL9lMCaj0tZ60TSGMadJPoiKoyU=",
        version = "v1.0.43",
    )
